...
namespace BusinessObjects
{
    public partial class FunewsManagementContext : DbContext
    {
        ...
        public virtual DbSet<SystemAccount> SystemAccounts { get; set; }
        public virtual DbSet<Tag> Tags { get; set; }
        public virtual DbSet<NewsTag> NewsTags { get; set; } // Thêm bảng NewsTag vào DbContext
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NewsTag>(entity =>
            {
                ...
                entity.Property(nt => nt.NewsArticleID)
                    .HasMaxLength(20)
                    .HasColumnName("NewsArticleID");

                entity.Property(nt => nt.TagID)
                    .HasColumnName("TagID");

                entity.HasOne(nt => nt.NewsArticle)
                    .WithMany(na => na.NewsTags)
                    .HasForeignKey(nt => nt.NewsArticleID)
                    .OnDelete(DeleteBehavior.Cascade) // Khi xóa NewsArticle, xóa luôn NewsTag
                    .HasConstraintName("FK_NewsTag_NewsArticle");

                entity.HasOne(nt => nt.Tag)
                    .WithMany(t => t.NewsTags)
                    .HasForeignKey(nt => nt.TagID)
                    .OnDelete(DeleteBehavior.Cascade) // Khi xóa Tag, xóa luôn NewsTag
                    .HasConstraintName("FK_NewsTag_Tag");
            });
